...
/**
* A copy of the Cucumber JSONFormatter that spools to a file (specified in the
* constructor)
*
*/
public final class JSONFileFormatter implements EventListener {
	...
	public JSONFileFormatter(Appendable out) throws FileNotFoundException {
		PrintStream ps = new PrintStream(new File(KimchiConstants.DEFAULT_OUTPUT_FILE));
		this.out = new NiceAppendable(ps);
	}
